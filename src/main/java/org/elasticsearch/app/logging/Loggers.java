...
package org.elasticsearch.app.logging;
...
public class Loggers {
    ...
    public static ESLogger getLogger(Class clazz, Settings settings, ShardId shardId, String... prefixes) {
        return getLogger(clazz, settings, shardId.getIndex(), Lists.asList(Integer.toString(shardId.id()), prefixes).toArray(new String[0]));
    }
    ...
    public static ESLogger getLogger(String loggerName, Settings settings, ShardId shardId, String... prefixes) {
        return getLogger(loggerName, settings, Lists.asList(shardId.getIndex().getName(), Integer.toString(shardId.id()), prefixes).toArray(new String[0]));
    }
